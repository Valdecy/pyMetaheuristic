...
| [Artificial Ecosystem Optimization](https://doi.org/10.1007/s00521-019-04452-x) | `aeo` | nature | Yes | Yes | No | Yes | `aeo.selection`<br>`aeo.consumer_decomposer_update`<br>`aeo.production_worst_agent` |
...
| [Dandelion Optimizer](https://doi.org/10.1016/j.engappai.2022.105075) | `do_dandelion` | swarm | Yes | Yes | No | Yes | `do_dandelion.rising_seed_phase`<br>`do_dandelion.descent_diffusion_phase`<br>`do_dandelion.elite_landing_phase`<br>`do_dandelion.candidate_generation`<br>`do_dandelion.selection` |
