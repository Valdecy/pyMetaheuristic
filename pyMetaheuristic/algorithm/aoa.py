...
# Lesson: Arithmetic Optimization Algorithm

# Citation: 
# PEREIRA, V. (2021). Project: Metaheuristic-Arithmetic Optimization Algorithm, File: aoa.py, GitHub repository: <https://github.com/Valdecy>
...
# AOA Function
def arithmetic_optimization_algorithm(size = 5, min_values = [-5,-5], max_values = [5,5], iterations = 50, alpha = 0.5, mu = 5, target_function = target_function):    
    count      = 0  
