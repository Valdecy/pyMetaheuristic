...
# Lesson: Dragonfly Algorithm

# Citation: 
# PEREIRA, V. (2021). Project: Metaheuristic-Dragonfly_Algorithm, File: da.py, GitHub repository: <https://github.com/Valdecy>
...
# DA Function
def dragonfly_algorithm(size = 3, min_values = [-5,-5], max_values = [5,5], generations = 50, target_function = target_function):
