...
def alpha_position(dimension, min_values, max_values, target_function = target_function):
...
def beta_position(dimension, min_values, max_values, target_function = target_function):
...
def delta_position(dimension, min_values, max_values, target_function = target_function):
...
def grey_wolf_optimizer(pack_size = 5, min_values = [-5,-5], max_values = [5,5], iterations = 50, target_function = target_function, verbose = True):    
    count    = 0
    alpha    = alpha_position(len(min_values), min_values, max_values, target_function)
    beta     = beta_position(len(min_values), min_values, max_values, target_function)
    delta    = delta_position(len(min_values), min_values, max_values, target_function)
