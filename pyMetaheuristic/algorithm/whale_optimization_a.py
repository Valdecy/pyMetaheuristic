...
def leader_position(dimension, min_values, max_values, target_function = target_function):
...
def whale_optimization_algorithm(hunting_party = 5, spiral_param = 1,  min_values = [-5,-5], max_values = [5,5], iterations = 50, target_function = target_function, verbose = True):    
    ...
    leader   = leader_position(len(min_values), min_values, max_values, target_function)
