...
# Lesson: Biogeography-Based Optimization

# Citation: 
# PEREIRA, V. (2021). Project: Metaheuristic-Biogeography-Based Optimization, File: bbo.py, GitHub repository: <https://github.com/Valdecy>
...
# BBO Function
def biogeography_based_optimization(population_size = 5, mutation_rate = 0.1, elite = 0, min_values = [-5,-5], max_values = [5,5], eta = 1, generations = 50, target_function = target_function):    
    count      = 0
