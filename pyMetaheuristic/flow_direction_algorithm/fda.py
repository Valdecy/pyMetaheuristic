...
# Lesson: Flow Direction Algorithm

# Citation: 
# PEREIRA, V. (2021). Project: Metaheuristic-Flow Direction Algorithm, File: fda.py, GitHub repository: <https://github.com/Valdecy/>
...
# FDA Function
def flow_direction_algorithm(size = 5, beta = 8, min_values = [-5,-5], max_values = [5,5], iterations = 50, target_function = target_function):    
    count      = 1
