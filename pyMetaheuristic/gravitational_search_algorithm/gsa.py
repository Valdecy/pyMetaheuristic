...
# Lesson: Gravitational Search Algorithm

# Citation: 
# PEREIRA, V. (2018). Project: Metaheuristic-Gravitational Search Algorithm, File: gsa.py, GitHub repository: <https://github.com/Valdecy>
...
# GSA Function
def gravitational_search_algorithm(swarm_size = 5, min_values = [-5,-5], max_values = [5,5], iterations = 50, target_function = target_function):    
    count       = 0
