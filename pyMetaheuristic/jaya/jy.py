...
# Lesson: Jaya (Sanskrit Word for Victory)

# Citation: 
# PEREIRA, V. (2021). Project: Metaheuristic-Genetic_Algorithm, File: Python-MH-Jaya.py, GitHub repository: <https://github.com/Valdecy>
