...
_TABLE_ALGORITHM_IDS: set[str] = {
    ...
    'ddao', 'dvba', 'eoa', 'ecological_cycle_o', 'eco', 'ego', 'esoa', 'ecpo', 'eso', 'efo', 'eho',
    'elk_ho', 'epc', 'evo', 'eao', 'eo', 'esc', 'es', 'ep', 'edo', 'eto', 'fep', 'fata', 'frofi',
    'ffo', 'fla', 'firefly_a', 'fwa', 'fss', 'frcg', 'flood_a', 'fda', 'fpa', 'fdo', 'fbio', 'foa',
    'fox', 'ffa', 'gska', 'gazelle_oa', 'gndo', 'ga', 'gkso', 'gmo', 'gco', 'gea', 'gto', 'gso',
    'gjo', 'gbo', 'gpso', 'goa', 'gsa', 'gwo', 'ggo', 'go_growth', 'hsa', 'hho', 'hbo', 'hgso',
    'hiking_oa', 'hc', 'ho_hippo', 'horse_oa', 'hco', 'heoa', 'hgs', 'hus', 'hba', 'hsaba', 'ica',
    'i_gwo', 'ilshade', 'imode', 'i_woa', 'iwo', 'ivya', 'jy', 'jso', 'kma', 'kha', 'liwo', 'lco',
    'l2smea', 'loa', 'lca', 'lpo', 'lfd', 'mrfo', 'mshoa', 'mpa', 'memetic_a', 'mso', 'mbo', 'mke',
    'moss_go', 'mvpa', 'mfa', 'msa_e', 'mgo', 'misaco', 'mvo', 'mfea', 'mfea2', 'mts', 'samso',
    'nmra', 'nmm', 'nndrea_so', 'noa', 'ngo', 'nro', 'nca', 'ofa', 'ooa', 'plba', 'pcx',
    'parrot_o', 'pso', 'pfa', 'poa', 'pko', 'plo', 'political_o', 'pro', 'pbil', 'pdo', 'pss',
    'puma_o', 'qio', 'qsa', 'random_s', 'rso', 'rbmo', 'roa', 'rsa', 'rime', 'rmsprop', 'run',
    'rfo', 'sfo', 'ssa', 'sade_sammon', 'scso', 'sbo', 'slo', 'soa', 'seaho', 'saro', 'ssio_rl',
    'sboa', 'saba', 'jde', 'sqp', 'serval_oa', 'srsr', 'sto', 'sa', 'sine_cosine_a', 'scho', 'sma',
    'so_snake', 'snow_oa', 'ssdo', 'sspider_a', 'sso', 'sparrow_sa', 'smo', 'shio', 'sho',
    'squirrel_sa', 'soo', 'sfoa', 'sd', 'spbo', 'shade', 'superb_foa', 'supply_do', 'sacc_eam2',
...
_POPULATION_BASED: set[str] = {
    ...
    'chicken_so', 'choa', 'circle_sa', 'csbo', 'clonalg', 'coati_oa', 'cockroach_so', 'cso',
    'coot', 'cro', 'chio', 'cmaes', 'coa', 'crayfish_oa', 'cem', 'csa', 'cuckoo_s', 'ca',
    'do_dandelion', 'dso', 'doa', 'de', 'hde', 'dfo', 'da', 'dbo', 'dmoa', 'ddao', 'dvba', 'eoa',
    'ecological_cycle_o', 'eco', 'ego', 'esoa', 'ecpo', 'eso', 'efo', 'eho', 'elk_ho', 'epc',
    'evo', 'eao', 'eo', 'esc', 'es', 'ep', 'edo', 'eto', 'fep', 'fata', 'frofi', 'ffo', 'fla',
    'firefly_a', 'fwa', 'fss', 'flood_a', 'fda', 'fpa', 'fdo', 'fbio', 'foa', 'fox', 'ffa', 'gska',
    'gazelle_oa', 'gndo', 'ga', 'gkso', 'gmo', 'gco', 'gea', 'gto', 'gso', 'gjo', 'gbo', 'gpso',
    'goa', 'gsa', 'gwo', 'ggo', 'go_growth', 'hsa', 'hho', 'hbo', 'hgso', 'hiking_oa', 'ho_hippo',
    'horse_oa', 'hco', 'heoa', 'hgs', 'hus', 'hba', 'hsaba', 'ica', 'i_gwo', 'ilshade', 'imode',
    'i_woa', 'iwo', 'ivya', 'jy', 'jso', 'kma', 'kha', 'liwo', 'lco', 'l2smea', 'loa', 'lca',
    'lpo', 'lfd', 'mrfo', 'mshoa', 'mpa', 'memetic_a', 'mso', 'mbo', 'mke', 'moss_go', 'mvpa',
    'mfa', 'msa_e', 'mgo', 'misaco', 'mvo', 'mfea', 'mfea2', 'mts', 'samso', 'nmra', 'nmm',
    'nndrea_so', 'noa', 'ngo', 'nro', 'nca', 'ofa', 'ooa', 'plba', 'pcx', 'parrot_o', 'pso', 'pfa',
    'poa', 'pko', 'plo', 'political_o', 'pro', 'pdo', 'pss', 'puma_o', 'qio', 'qsa', 'random_s',
    'rso', 'rbmo', 'roa', 'rsa', 'rime', 'run', 'rfo', 'sfo', 'ssa', 'sade_sammon', 'scso', 'sbo',
    'slo', 'soa', 'seaho', 'saro', 'ssio_rl', 'sboa', 'saba', 'jde', 'serval_oa', 'srsr', 'sto',
...
_INJECTION_ENABLED: set[str] = {
    ...
    'artemisinin_o', 'abco', 'aeo', 'aefa', 'afsa', 'agto', 'aha', 'ala', 'apo', 'aro', 'autov',
    'bco', 'bfo', 'bes', 'bmo', 'bat_a', 'bro', 'bea', 'bspga', 'bbo', 'bsa', 'bwo', 'bka', 'bono',
    'bso', 'bboa', 'boa', 'camel', 'capsa', 'cat_so', 'chameleon_sa', 'cgo', 'cddo', 'cdo', 'choa',
    'circle_sa', 'csbo', 'clonalg', 'coati_oa', 'cockroach_so', 'cso', 'coot', 'cro', 'chio',
    'cmaes', 'coa', 'crayfish_oa', 'cem', 'csa', 'cuckoo_s', 'ca', 'do_dandelion', 'dso', 'doa',
    'de', 'hde', 'dfo', 'da', 'dbo', 'dmoa', 'ddao', 'dvba', 'eoa', 'ecological_cycle_o', 'eco',
    'ego', 'esoa', 'ecpo', 'eso', 'efo', 'eho', 'elk_ho', 'epc', 'evo', 'eao', 'eo', 'esc', 'es',
    'ep', 'edo', 'eto', 'fep', 'fata', 'frofi', 'ffo', 'fla', 'firefly_a', 'fwa', 'fss', 'flood_a',
    'fda', 'fpa', 'fdo', 'fbio', 'foa', 'fox', 'ffa', 'gska', 'gazelle_oa', 'gndo', 'ga', 'gkso',
    'gmo', 'gco', 'gea', 'gto', 'gso', 'gjo', 'gbo', 'gpso', 'goa', 'gsa', 'gwo', 'ggo',
    'go_growth', 'hho', 'hbo', 'hgso', 'hiking_oa', 'ho_hippo', 'horse_oa', 'hco', 'heoa', 'hgs',
    'hus', 'hba', 'hsaba', 'ica', 'i_gwo', 'ilshade', 'imode', 'i_woa', 'iwo', 'ivya', 'jy', 'jso',
    'kma', 'liwo', 'lco', 'l2smea', 'loa', 'lca', 'lpo', 'lfd', 'mrfo', 'mshoa', 'mpa',
    'memetic_a', 'mso', 'mbo', 'mke', 'moss_go', 'mvpa', 'mfa', 'msa_e', 'mgo', 'misaco', 'mvo',
    'mfea', 'mfea2', 'mts', 'samso', 'nmra', 'nmm', 'nndrea_so', 'noa', 'ngo', 'nro', 'nca', 'ofa',
    'ooa', 'plba', 'pcx', 'parrot_o', 'pso', 'pfa', 'poa', 'pko', 'plo', 'political_o', 'pro',
    'pdo', 'pss', 'puma_o', 'qio', 'qsa', 'random_s', 'rso', 'rbmo', 'roa', 'rsa', 'rime', 'run',
    'rfo', 'sfo', 'ssa', 'sade_sammon', 'scso', 'sbo', 'slo', 'soa', 'seaho', 'saro', 'ssio_rl',
...
_ALGORITHM_DOIS: dict[str, str] = {
    ...
    'ars'               : 'https://algorithmafternoon.com/stochastic/adaptive_random_search/',
