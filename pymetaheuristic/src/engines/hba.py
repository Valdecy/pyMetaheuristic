...
class HBAEngine(PortedPopulationEngine):
    ...
    def _step_impl(self, state, pop):
        ...
        for i in range(n):
            ...
            attempted_label = "hba.bat_frequency_movement"
            if bool(self._params.get("use_de_local_search", False)):
                ...
                if self._is_better(fde, fsol):
                    sol, fit = de, fde
                    attempted_label = "hba.de_local_search"
                else:
                    fit = fsol
            else:
        ...
        return pop, evals, {"velocities": velocities, "loudness": loudness, "pulse_rate": pulse_rate, "operator_labels": operator_labels}
