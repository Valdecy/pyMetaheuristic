"""pyMetaheuristic src — Sine Cosine Algorithm Engine"""
...
class SINE_COSINE_AEngine(BaseEngine):
    ...
    def __init__(self, problem, config):
        ...
        self._a=float(p["a_linear_component"])
    ...
    def step(self, state):
        ...
        r1=self._a-t*(self._a/T)
        r2=2*np.pi*np.random.rand(self._n,self.problem.dimension)
