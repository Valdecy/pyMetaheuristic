...
ARGUMENT_REFERENCE = [
    ...
    {'callable': 'create_optimizer', 'signature': '(algorithm, target_function=None, min_values=None, max_values=None, objective="min", constraints=None, constraint_handler=None, variable_types=None, repair_function=None, repair_name=None, callbacks=None, init_function=None, init_name=None, problem=None, penalty_coefficient=1000000.0, equality_tolerance=1e-06, resample_attempts=25, max_steps=None, max_evaluations=None, target_fitness=None, seed=None, verbose=False, store_history=True, store_population_snapshots=False, snapshot_interval=1, timeout_seconds=None, config=None, termination=None, **params)', 'summary': 'Create and return an engine instance (does not run it). Supports callbacks, named repair strategies, named initialisation presets, and Problem objects.', 'arguments': [
        ...
        {'name': 'init_name', 'required': False, 'default': 'None', 'annotation': 'str | None', 'description': 'Named initialisation preset.', 'accepted_values': 'uniform, lhs, latin_hypercube, lhs_population, obl, sobol, chaotic:<map>'},
    ...
    {'callable': 'plot_convergence', 'signature': '(result, filepath=None, title=None, show=False, x_axis="steps")', 'summary': 'Plot the convergence curve of one run (Plotly). Supports step- or evaluation-indexed curves.', 'arguments': []},
    {'callable': 'compare_convergence', 'signature': '(results, labels=None, filepath=None, title="Convergence comparison", show=False, x_axis="steps")', 'summary': 'Overlay multiple convergence curves in one plot (Plotly).', 'arguments': []},
    ...
    {'callable': 'get_init_function', 'signature': '(name)', 'summary': 'Resolve a named init preset to a callable; accepts lhs, latin_hypercube, lhs_population, obl, sobol, uniform, and chaotic:<map>.', 'arguments': []},
